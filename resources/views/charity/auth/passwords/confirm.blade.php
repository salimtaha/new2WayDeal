            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2"> رمز التحقق 🔒</h4>
                        <p class="mb-4">
                            رمز التحقق يتم استخدامه لمره واحده فقط
                        </p>
                        <form id="formAuthentication" class="mb-3"
                            action="{{ route('charities.password.check.otp') }}" method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="otp" class="form-label">رمز التحقق </label>
                                <input type="text" class="form-control" id="otp" name="otp"
                                    placeholder="ادخل رمز التحقق هنا ..." autofocus />
                            </div>
                            @if ($errors->any())
