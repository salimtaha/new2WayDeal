...
<head>
    ...
    <title>اعاده تعيين كلمه المرور</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">اعاده تعيين كلمه المرور 🔒</h4>
                        <p class="mb-4">

                        </p>
                        <form id="formAuthentication" class="mb-3" action="{{ route('charities.password.reset') }}"
                            method="post">
                            @csrf
                            <div class="mb-3">
                                <label for="password" class="form-label">كلمه السر الجديده </label>
                                <input type="password" class="form-control" id="password" name="password"
                                    placeholder="  ادخل كلمه السر" autofocus />
                            </div>
                            @if ($errors->any())
                            ...
                            @endif
                            <div class="mb-3">
                                <label for="password" class="form-label">تاكيد كلمه السر الجديده</label>
                                <input type="password" class="form-control" id="password_confirmation"
                                    name="password_confirmation" placeholder="  تاكيد كلمه السر" autofocus />
                            </div>
