...
@section('title', ' المتاجر المحذوفه')
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <span style="display: flex">
                            <form action="{{ route('admin.stores.trashed') }}" method="POST">
                                @csrf
                            ...
                            <tbody id="withdrawalTableBody">
                                @forelse ($stores as  $store)
                                    <tr>
                                        ...
                                        <td>{{ $store->deleted_at->format('Y-m-d h:m:s') }}</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu ">
                                                    <a id="deleteBtn" data-id="' . $row->id . '"class="dropdown-item"
                                                        ...
                                                        data-bs-target="#deletemodal{{ $store->id }}"> الحذف النهائي <i
                                                            class="fa fa-trash"></i></a>
                                                            <a class="dropdown-item "
                                                            href="{{ Route('admin.stores.restore', $store->id) }}">استرجاع <i class="fa fa-undo" aria-hidden="true"></i></a>
                                                    <a class="dropdown-item "
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">هل انت متاكد من حذف
                                                        متجر : {{ $store->name }} ؟</h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('admin.stores.forcedelete', $store->id) }}"
