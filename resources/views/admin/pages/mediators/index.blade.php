    ...
    <div class="page-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="page-header-left">
                            <h3 style="color: rgb(236, 73, 73)"> مسئولي السحب
                            </h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">مسئولي السحب</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <form action="{{ route('admin.mediators.destroy') }}" method="POST">
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#editableTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ Route('admin.mediators.getall') }}",
                columns: [
