...
@section('title', 'اداره الارباح الشهريه')
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="page-header-left">
                    <h3 style="color: rgb(236, 73, 73)"> الارباح الشهريه
                    </h3>
                </div>
            </div>
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active"><a href=""> الارباح الشهريه  </a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.profits.index.daily') }}" type="button" class="btn btn-primary mt-md-0 mt-2">الربح اليومي</a>
                </div>
                <div class="card-body">
