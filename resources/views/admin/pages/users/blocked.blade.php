...
@section('title', 'المستخدمين المحظورين')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active"><a style="text-decoration: none;color:black" href="{{ route('admin.users.index') }}">المستخدمين</a> </li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#editableTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.users.blocked.getall') }}",
                    data: function(d) {
