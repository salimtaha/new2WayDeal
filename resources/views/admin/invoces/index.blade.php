            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="page-header-left">
                        <h3 style="color: rgb(236, 73, 73)"> الفواتير
                        </h3>
                    </div>
                </div>
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active"><a href=""> الفواتير </a>
                        </li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#editableTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.invoices.getall') }}",
                    data: function(d) {
                ...
                {
                    data: 'shapping_status',
                    name: 'shapping_status',
                    orderable: false,
                    searchable: false
                },
