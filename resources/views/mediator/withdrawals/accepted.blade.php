...
@section('title', 'الطلبات المقبوله ')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class=" shadow-info border-radius-lg pt-4 pb-3" style="background: rgb(94, 92, 92)">
                            <h6 class="text-white text-center text-capitalize ps-3">* طلبات السحب المقبوله * </h6>

                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <form class="row" action="{{ route('mediators.accepted.index') }}" method="POST">
                                @csrf
                                <div class="col-md-3">
                                    ...
                                    @forelse ($withdrawals as $withdrawal)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm bg-gradient-success">{{ $withdrawal->status == 'accepted' ? 'تم السحب ' : 'غير معرف' }}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <!--*************************************-->
                                                        <a class="btm btn-sm btn-success" href="{{ route('mediators.pending.show',$withdrawal->id) }}"><i class="bi bi-eye"></i> عرض</a>
                                              </td>
                                        </tr>
                                    @empty
                                        <tr>
